...
export const metadata: Metadata = {
    ...
    description:
        'Undangan pernikahan digital untuk pernikahan Afifah & Haidar pada tanggal 23 November 2024. Temukan informasi lengkap tentang lokasi, waktu acara. Hadirkan kebahagiaan dengan berbagi momen spesial ini bersama kami!',
    icons: {
        icon: '/favicon.jpeg',
    ...
    return (
        <html lang="en">
            <head>
                ...
                <meta
                    property="og:image"
                    content="https://wedding-afifah-haidar.netlify.app/favicon.jpeg"
                />
